...
@Composable
internal fun HistoryMovieView(
    navController: NavController,
    historyMovie: Response<HistoryMovie>
) {
    if(historyMovie !is Response.Error){
        Row(
        ...
        LazyRow(content = {
            if (historyMovie is Response.Success){
                items(historyMovie.data!!.items){ item ->
                    Column(
